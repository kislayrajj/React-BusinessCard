...
const MainContent= () => {
    ...
    <div className='text-xs mt-1'>Hello! I'm someone who's deeply passionate about crafting solutions that truly make a difference, driven by a desire to positively impact lives.</div>
     ...
     <div className="follow mt-3 m-1 flex justify-between text-3xl text-white ">
      <div className="git"><i class="fa-brands fa-square-github"></i></div>
      <div className='twitter'><i class="fa-brands fa-square-x-twitter"></i></div>
      <div className='fb'><i class="fa-brands fa-facebook"></i></div>
      <div className='insta'><i class="fa-brands fa-square-instagram"></i></div>
     </div>
      </div>
