...
const MainContent = () => {
  return (
    <div title="Main Component" className="p-3 m-1  text-white ">
      ...
      <div className="follow mt-3 m-1 flex justify-between text-3xl text-white ">
        <a href="https://github.com/kislayrajj">
          <div className="git cursor-pointer">
            <i className="fa-brands fa-square-github"></i>
          </div>
        </a>
        <a href="https://twitter.com/Kislayrajj">
        ...
        <a href="https://www.instagram.com/kislayrajj/?igsh=MTFpbzlnYmZvN2RudA%3D%3D">
